...
class EstadoJuego:
    ...
    def elegir_asignatura(self, asignatura: Asignatura):
        ...
        if nuevo_estado.javier_horas in [18, 19, 20]:
        ...
        if nuevo_estado.fernando_horas in [18, 19, 20]:
            horas_restantes = sum(a.horas for a in nuevo_estado.asignaturas_restantes)
    ...
    def evaluar_resultado(self):
        ...
        -  0: Empate menos preferido (Javier 20h).
        - -1: Empate (reparto válido, nadie coge FFE).
        - -2: Derrota (Javier coge FFE en un reparto válido).
        """
        total_horas = self.javier_horas + self.fernando_horas
        reparto_valido = (self.javier_horas, self.fernando_horas) in [(19, 19), (18, 20), (20, 18)]
        ...
        if self.javier_horas == 20:
            return 0 # Empate menos preferido
        
        return -1 # Empate normal

...
Si quisieramos utilizar este modelo para predecir la altura de una persona que pesa `{python} f"{nuevo_peso}"` kg, simplemente sustituimos el valor del peso en la ecuación:
